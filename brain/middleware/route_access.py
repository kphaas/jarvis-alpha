...
ROUTE_ACCESS_POLICIES: dict[str, RouteAccessPolicy] = {
    ...
    "GET /v1/health/agents": RouteAccessPolicy(admin_only=True),
    "GET /v1/health/temporal-storage": RouteAccessPolicy(admin_only=True),
    "GET /v1/health/maintainer": RouteAccessPolicy(admin_only=True),
