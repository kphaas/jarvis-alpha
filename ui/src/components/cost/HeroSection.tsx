...
export function HeroSection({
  ...
  const cardBase = `rounded-2xl border p-3 backdrop-blur-xl ${border} ${
  ...
  return (
    <section className="space-y-3">
      ...
      {!isLoading && !err && data && (
        <>
          <div className={`rounded-2xl border px-4 py-3 ${border} ${isDark ? 'bg-white/[0.02]' : 'bg-white/50'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-4">
            <div className={cardBase}>
              <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-500/90 mb-2">
                Estimated monthly
              </p>
              <p className="text-2xl font-semibold tracking-tight tabular-nums text-balance">
            ...
            <div className={cardBase}>
              <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-sky-500/90 mb-2">
                CLOUD CREDITS
              </p>
