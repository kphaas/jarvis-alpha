  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/95">
      <div className="w-full max-w-sm rounded-xl border border-gray-700 bg-gray-800 p-8 shadow-2xl mx-4">
        ...
        <p className="mb-5 text-center text-sm leading-6 text-gray-300">
          One Alpha session unlocks approved AT-0 operator surfaces.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <p className="mt-2 text-xs text-gray-400">
              Numeric PINs up to {MAX_PIN_LENGTH} digits are supported.
            </p>
          </div>
          {error ? (
